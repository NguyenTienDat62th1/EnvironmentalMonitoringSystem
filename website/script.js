document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("registerForm").addEventListener("submit", async function (event) {
      ...
      if (!validatePassword(password)) {
        alert(
          "Mật khẩu không hợp lệ! Mật khẩu phải có ít nhất 8 ký tự, bao gồm 1 chữ cái viết hoa, 1 số và không chứa ký tự đặc biệt."
        );
        return;
      }
  ...
  const sensorData = [
    { id: "temperature", icon: "fas fa-temperature-high",name: "Nhiệt độ", unit: "°C" },
    { id: "humidity", icon: "fas fa-tint", name: "Độ ẩm không khí", unit: "%" },
    { id: "soil_moisture", icon: "fas fa-water", name: "Độ ẩm đất", unit: "%" },
    { id: "pH", icon: "fas fa-flask", name: "Độ pH đất", unit: "" },
    { id: "light", icon: "fas fa-sun", name: "Chỉ số ánh sáng", unit: "lux" },
    { id: "CO2", icon: "fas fa-smog", name: "Chỉ số CO2", unit: "ppm" },
    { id: "nutrients", icon: "fas fa-seedling", name: "Mức độ dinh dưỡng của đất", unit: "" },
    { id: "wind_speed", icon: "fas fa-wind", name: "Tốc độ gió", unit: "km/h" },
    { id: "wind_direction", icon: "fas fa-compass", name: "Hướng gió", unit: "°" },
    { id: "water_quality", icon: "fas fa-water", name: "Chất lượng nước", unit: "TDS" },
  ];
